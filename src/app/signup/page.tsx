...
export default function Signup() {
  ...
  return (
    <div className='flex justify-center items-center flex-col w-[312px] md:w-[384px] lg:w-[640px] mt-[58px] md:mt-[80px] m-auto mb-[104px] lg:mb-[220px]'>
      <div>
      ...
      <div className='w-full mt-[50px] md:mt-[60px]'>
        <form onSubmit={handleSubmit(onSubmit)}>
          <p className='text-md md:text-lg lg:text-xl font-medium text-blue-900'>이메일</p>
          <Input
            id='email'
            placeholder='이메일'
            type='email'
          ...
          <Button
            ...
            size='lg'
            type='submit'
            className={!isValid ? 'mt-[30px] md:mt-10 cursor-not-allowed' : 'mt-[30px] md:mt-10'}
            disabled={!isValid}
          >
            가입하기
          </Button>
