...
export default function AddEpigram() {
  return (
    <div className='flex justify-center items-start flex-col m-auto w-[312px] md:w-[384px] lg:w-[640px] mt-[24px] md:mt-[32px] lg:mt-[56px] mb-[30px] '>
      ...
      <div className='w-[312px] md:w-[384px] lg:w-[640px] mt-6 md:mt-8 lg:mt-10'>
        ...
        <Input placeholder='저자 이름 입력' className='bg-transparent h-11 lg:h-16 mt-3 lg:mt-4' />

        <p className='flex items-center text-md md:text-lg lg:text-xl font-semibold mt-10 lg:mt-[54px]'>
          출처
        </p>
        <Input placeholder='출처 제목 입력' className='bg-transparent h-11 lg:h-16 mt-3 lg:mt-4' />
        <Input
